...
Мы были вместе ещё один год. Казалось бы, простой поход в магазин, но с тобой даже такие моменты были особенными. Мне всегда было важно знать твоё мнение, поэтому выбирать обувь с тобой — не просто покупка.
...
P.s А ещё именно в тот день мы окончательно поняли: ты — настоящий окушок! 🐟💙""",
        "files": [
            ...
            "https://drive.google.com/file/d/1Bprh73cvlw8bxMYEs3UksGkfsChgSsrh/view?usp=drive_link",
            "https://drive.google.com/file/d/1JKA4jqkA5oY-NEARjFczg2xqucyENPu2/view?usp=drive_link",
            "https://drive.google.com/file/d/1OsGYCJvIPTZxlxti21GuLw4s9QvuxMuW/view?usp=drive_link",
            "https://drive.google.com/file/d/1IYBODimHVysMnGLIA9koRJ7PKBasv2E2/view?usp=drive_link",
            "https://drive.google.com/file/d/1ebPBe0EBAbuySSwH1hbxA6fdyIZ16lua/view?usp=drive_link",
            "https://drive.google.com/file/d/1u0nhW5IHJlS8UsQsVTWdJfnJjVBnhuzk/view?usp=drive_link"
